...
call del ids-connector\build\libs\libraryJars\idscp2-0.4.3.jar
call copy ..\ids-idscp2-java\idscp2\build\libs\idscp2-0.4.5-ex.jar ids-connector\build\libs\libraryJars\idscp2-0.4.5-ex.jar
call cd  buildx
